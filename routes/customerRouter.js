...
module.exports = function (io){
  ...
  customerRouter.get("/getLoginPage", (res, req) =>
    customerController.getLoginPage(res, req)
  );
  customerRouter.get("/getSignUpPage", (res, req) =>
    customerController.getSignUpPage(res, req)
  );
  customerRouter.get("/profile", (res, req) =>
    customerController.getProfilePage(res, req)
  );
  ...
  customerRouter.post("/order-details", async function (req, res) {
    await orderController.confirmOrder(req, res, req.body.current_van,io);
  });
  ...
  customerRouter.post("/logout", function (req, res) {
    // save the favourites
    customerController.saveAfterLogOut(
      req,
      res,
      req.body.logoutitems,
      req.body.logoutqty
    );
    req.logout();
    req.flash("");
  ...
  //handle the GET request to get the home page
  customerRouter.get("/", (res, req) =>
    customerController.getStartPage(res, req)
  );
